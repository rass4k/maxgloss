...
export default function Cotizador() {
    ...
    const [modalidad, setModalidad] = useState<"domicilio" | "coordinar">("domicilio");
    const [comunaSector, setComunaSector] = useState("");
    ...
    const enviarWhatsApp = () => {
        ...
        if (!marcaModelo.trim()) {
            alert("Ingresa la marca y modelo del vehículo.");
            return;
        }

        if (!comunaSector.trim()) {
            alert("Ingresa tu comuna o sector.");
            return;
        }
...
${direccion.trim()}`
                : `🏠 Modalidad:
Coordinar atención con Max Gloss
                                ...
                                {paso === 3 && (
                                    <div>
                                        <div className="mb-4">
                                            ...
                                            <p className="mt-1 text-[13px] leading-5 text-zinc-500 sm:text-sm sm:leading-6">
                                                Enviaremos esta información junto a tu solicitud por WhatsApp.
                                            </p>
                                        </div>
                                        ...
                                        <div className="grid gap-3 sm:grid-cols-2">
                                            <div>
                                                <label
                                                    htmlFor="nombre"
                                                    className="text-[10px] font-bold uppercase tracking-[0.20em] text-zinc-500"
                                                >
                                                    Nombre
                                                </label>
                                                <input
                                                    ...
                                                    autoComplete="name"
                                                    className="mt-2 h-11 w-full rounded-xl border border-white/10 bg-black/70 px-4 text-sm text-white outline-none transition placeholder:text-zinc-700 focus:border-[#d71920]"
                                                />
                                            </div>
                                        ...
                                        {/* MODALIDAD */}
                                        <div className="mt-4">
                                            <p className="text-[10px] font-bold uppercase tracking-[0.20em] text-zinc-500">
                                        ...
                                        >
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    type="text"
                                                    value={comunaSector}
                                                    onChange={(e) => setComunaSector(e.target.value)}
                                                    placeholder="Ej: Constitución, centro"
                                        ...
                                        <div className="mt-3 flex items-center justify-center gap-2 text-center text-[11px] text-zinc-600">
                                            <Lock size={13} className="shrink-0" />
                                            <span>
                                                Tus datos se usan solo para gestionar esta cotización por WhatsApp.
                                            </span>
                                        </div>
                                    </div>
                                )}
